...
mods-flip-x = Parallel Flip
mods-flip-x-sub = Mirrors the chart horizontally (X axis).
mods-flip-y = Vertical Flip
mods-flip-y-sub = Mirrors the chart vertically (Y axis); judgement is mirrored too.
...
mods-ghost = Ghost
mods-ghost-sub = Makes notes translucent.
mods-random-x = Random X
mods-random-x-sub = Scatters every note to a deterministic random X (visual only).
mods-fx-tv = Old TV
mods-fx-tv-sub = Old TV / VHS fullscreen effect.
mods-fx-scanline = Scanline
mods-fx-scanline-sub = Retro CRT scanline effect.
mods-fx-glitch = Glitch
mods-fx-glitch-sub = Signal glitch / tearing effect.
