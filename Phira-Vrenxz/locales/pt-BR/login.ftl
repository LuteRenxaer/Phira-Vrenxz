...
password = Senha
name-length-req = O comprimento do nome de usuário deve estar entre { $min } e { $max } caracteres
name-has-illegal-char = O nome de usuário contém caracteres ilegais
pwd-length-req = O comprimento da senha deve estar entre { $min } e { $max } caracteres
