                        ...
                        f.render(ui, t, |ui| {
                            ...
                            item.btn.render_shadow(ui, r, t, |ui, path| {
                                ...
                                if let Some(chart) = &mut item.chart {
                                    ...
                                    if selected.is_some() {
                                        ui.fill_path(&card_r.feather(0.006).rounded(CARD_CORNER_RADIUS + 0.003), selected_color);
                                    }
                                    ...
                                    if let Some((that_id, start_time)) = &self.back_fade_in {
                                        if id == *that_id {
                                            ...
                                            if p > 1. || get_data().prefer_reduced_motion {
                                                ...
                                                ui.fill_path(&card_path, semi_black(0.55 * (1. - p)));
                                                c.a *= p;
                                            }
                                        }
                                    }
                                    ...
                                    let mut level_text = ui
                                        ...
                                        .size(0.65 * r.w / cw)
                                        .color(c);
                                    let ms = level_text.measure();
                                    level_text.ui.fill_path(
                                        &ms.feather(0.01).rounded(0.015),
                                        Color {
                                            r: 0.0,
                                            g: 0.0,
                                            b: 0.0,
                                    ...
                                    if let Some(pos) = selected {
                                        ui.fill_path(&card_path, Color { a: 0.4, ..selected_color });
                                        let ct = card_r.center();
                                    ...
                                    ui.fill_path(&card_path, (*self.icons.r#abstract, card_r));
                                    ui.fill_path(&card_path, semi_black(0.2));
                                    let ct = card_r.center();
