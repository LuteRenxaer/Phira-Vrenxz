#version 100
// 花样 mod“故障”：信号故障/画面撕裂（基于 godot glitch shader 改编，参数更明显）
...
uniform float power; // %0.15%
uniform float rate; // %0.85% 0..1
uniform float speed; // %4.0%
uniform float blockCount; // %48.0%
uniform float colorRate; // %0.02% 0..1
